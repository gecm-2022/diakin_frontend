  ...
  const userdata = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setUser(r.user || {});
        setWallet(r.user?.wallet?.balance || 0);
  
        // Handle total recharge data
        const { totalRechargeCount = 0 } = r.totalRechargeData || {};
        setTotalRecharge(totalRechargeCount);
  
        // Handle total withdrawal data
        const { totalWithdrawalCount = 0 } = r.totalWithdrawalData || {};
        setTotalWithdrawal(totalWithdrawalCount);
